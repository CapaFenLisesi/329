...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/pendulum.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/ellipse.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/resonance.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/att1.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/att2.eps}}
\caption{\em The phase-space trajectory of a linear, damped, periodically driven,
...
\section{Validation of Numerical Solutions}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/valid.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/valid1.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/q05.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/q05p.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/scanvd.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/q124.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/q130d.eps}}
\caption{\em Equally spaced (in time) points on a time-asymptotic orbit in phase-space.
Data calculated  
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/q130u.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/scanvud.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=4in
%\centerline{\epsffile{Chapter04/basin0.eps}}
\centerline{\epsffile{Chapter04/basin0a.eps}}
...
\begin{figure}
\epsfysize=4in
%\centerline{\epsffile{Chapter04/basin1.eps}}
\centerline{\epsffile{Chapter04/basin1a.eps}}
...
\begin{figure}
\epsfysize=4in
%\centerline{\epsffile{Chapter04/basin2.eps}}
\centerline{\epsffile{Chapter04/basin2a.eps}}
\caption{\em  Detail of the basins of attraction for the asymmetric, mirror image, attractors
pictured in Figs.~\ref{f22} and \ref{f23}. Regions of $\theta(0)$--$v(0)$
space which lead to motion converging on the left-favouring attractor shown
in Fig.~\ref{f22} are coloured white: regions of $\theta(0)$--$v(0)$
...
Figure~\ref{f26} is a blow-up of a region close to the lower left-hand corner of Fig.~\ref{f25}. 
...
\begin{figure}
\epsfysize=3.75in
%\centerline{\epsffile{Chapter04/basin3.eps}}
\centerline{\epsffile{Chapter04/basin3a.eps}}
\caption{\em  Detail of the basins of attraction for the asymmetric, mirror image, attractors
pictured in Figs.~\ref{f22} and \ref{f23}. Regions of $\theta(0)$--$v(0)$
space which lead to motion converging on the left-favouring attractor shown
in Fig.~\ref{f22} are coloured white: regions of $\theta(0)$--$v(0)$
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/pd_scanvd.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/pd_phased.eps}}
\caption{\em Equally spaced (in time) points on a time-asymptotic orbit in phase-space. Data
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/pd_poincared.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/pd_scanvud.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=3.5in
\centerline{\epsffile{Chapter04/scanqv.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=3.5in
\centerline{\epsffile{Chapter04/scanqva.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
calculated numerically for
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/x1372.eps}}
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/x1375.eps}}
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/x13757.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/x1376.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/d1372.eps}}
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/d1375.eps}}
\caption{\em The $v$-component of the separation between two neighbouring
phase-space trajectories  (one of which lies on an attractor) plotted against normalized time. Data
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/d13757.eps}}
\caption{\em The $v$-component of the separation between two neighbouring
phase-space trajectories (one of which lies on an attractor) plotted against normalized time. Data
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/d1376.eps}}
\caption{\em The $v$-component of the separation between two neighbouring
phase-space trajectories (one of which lies on an attractor) plotted against normalized time. Data
...
\begin{figure}
\epsfysize=3.5in
\centerline{\epsffile{Chapter04/scan0.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=3.5in
\centerline{\epsffile{Chapter04/scan1.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/p76.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/p77.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/p78.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
\begin{figure}
\epsfysize=3.5in
\centerline{\epsffile{Chapter04/scan15.eps}}
\caption{\em The $v$-coordinate of the Poincar\'{e} section of a time-asymptotic orbit
plotted against the quality-factor $Q$. Data
 calculated numerically for
...
\begin{figure}
\epsfysize=2.25in
\centerline{\epsffile{Chapter04/x15.eps}}
\caption{\em Equally spaced (in time) points on a time-asymptotic orbit in phase-space. Data 
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/p213.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic orbit. Data
...
The interval between the second and third chaotic regions shown in Fig.~\ref{f49} is
...
\begin{figure}
\epsfysize=3in
\centerline{\epsffile{Chapter04/p39.eps}}
\caption{\em The Poincar\'{e} section of a time-asymptotic
